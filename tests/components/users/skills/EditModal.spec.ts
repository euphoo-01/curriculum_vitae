...
import EditModal from '../../../../app/components/users/skills/EditModal.vue';
...
describe('Users Skills EditModal Component', () => {
  it('renders correctly', async () => {
    const wrapper = await mountSuspended(EditModal, {
      props: {
        modelValue: true,
        editData: { name: 'Vue.js', mastery: Mastery.Proficient },
      },
      ...mountOptions,
    });

    expect(wrapper.exists()).toBe(true);
    expect(wrapper.text()).toContain('skills.edit');
  });
